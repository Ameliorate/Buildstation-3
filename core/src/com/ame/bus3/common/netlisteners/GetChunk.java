...
import com.ame.bus3.common.ChunkCoordinate;
...
public class GetChunk extends Listener {
	...
	public static void send(ChunkCoordinate location, Connection connection) {
	 ...
	 */
	public static void sendWait(ChunkCoordinate location, Connection connection) {
	...
	public static class GetChunkPacket {
		...
		public GetChunkPacket(ChunkCoordinate location, String waitingString) {
